...
export default function CartPage(){
    ...
    async function goToPayment(){
      const response = await axios.post('/api/checkout', {name, email, city, postCode, streetAddress, country, cartProducts});
                            ...
                            {cartProducts?.length &&(
                                <Box>
                                    <h2>Order information</h2>
                                            ...
                                            <Input type="text" placeholder="Street" value={streetAddress} name="streetAddress" onChange={ev => setStreetAddress(ev.target.value)}/>
